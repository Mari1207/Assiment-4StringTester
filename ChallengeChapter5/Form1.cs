...
namespace ChallengeChapter5
{
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            lblIndexOf.Text = "";
            //Find length
            txtLengh.Text = txtInput.Text.Length.ToString();
            ...
            //Replace
            temp = txtInput.Text;
            txtRemoveResult.Text = temp.Replace(txtReplaceChars.Text, txtReplaceWith.Text);
        ...
        private void TxtSubstringResult_TextChanged(object sender, EventArgs e)
        {
